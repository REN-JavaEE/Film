...
<script type="text/javascript">
	$(function() {
		$.getJSON("http://localhost:8088/filminfo/getfilminfos", function(data) {
...
<a href="http://localhost:8088/filminfo/getfilminfobyid?id={{filmInfo.id}}" class="hvr-sweep-to-bottom"><img
											...
											<div class="mid-1 agileits_w3layouts_mid_1_home">
												<div class="w3l-movie-text">
													<h6>
														<a href="single.jsp">{{filmInfo.name}}</a>
													</h6>
												</div>
...
<body>
	...
	<div class="w3_agilits_banner_bootm">
		<div class="w3_agilits_inner_bottom">
			<div class="col-md-6 wthree_agile_login">
				<ul>
					<li><a href="orderinfo/pdf" class="login">一键PDF</a></li>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="login-form">
						<form action="usera/login" method="post">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>Register</h4>
					<div class="login-form">
						<form id="register" action="usera/register" method="post">
						...
						<div class="tab1">
							<div class="tab_movies_agileinfo">
								<div class="w3_agile_featured_movies">
									...
									<div class="col-md-7 wthree_agile-movies_list" id="filmInfo">
	...
	<script type="text/javascript">
		$("#getvaild").click(function() {
			$.ajax({
				url : "http://localhost:8088/usera/getvaildcode?qq=" + $("#vaild").val()
			})
		})
		$(document).ready(function() {
