	...
	<body>
		...
		<div class="w3_agilits_banner_bootm">
			<div class="w3_agilits_inner_bottom">
				<div class="col-md-6 wthree_agile_login">
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i> (+086) 888 888 8888</li>
						<li>
						${message}
						</li>
						<li>
							<a href="#" class="login" data-toggle="modal" data-target="#myModal4">Login</a>
						</li>
						<li>
							<a href="#" class="login reg" data-toggle="modal" data-target="#myModal5">Register</a>
						</li>
						<li>
						${message2}
						</li>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4>Register</h4>
						<div class="login-form">
							<form action="usera/register" method="post">
								...
								<input type="text" id="vaild" name="qq" placeholder="QQ邮箱" required="">
								<input type="text" name="vaildCode" placeholder="请输入验证码" />
								<div style="background-color: darkgrey;width: 120px;height:25px"><a href="###" id="getvaild"><center>请输入验证码</center></a></div>
								<input type="password" name="password" placeholder="Password" required="">
									...
									<div class="w3_agile_featured_movies">
										<div class="col-md-5 video_agile_player">
											...
											<div class="player-text">
												...
												<p class="fexi_header_para"><span class="conjuring_w3">Story Line<label>:</label></span>Presenting the official trailer of Force 2 starring John Abraham, Sonakshi Sinha and Tahir Raj Bhasin A film by Abhinay Deo, Produced by Vipul Amrutlal Shah, JA entertainment Pvt. Ltd....</p>
									...
									<div class="w3_agile_featured_movies">
										<div class="col-md-5 video_agile_player">
											...
											<div class="player-text">
												...
												<p class="fexi_header_para"><span class="conjuring_w3">Story Line<label>:</label></span>Me Before You Official Trailer #2 (2016) - Emilia Clarke, Sam Claflin Movie HD A girl in a small town forms an unlikely bond with a recently-paralyzed man she's taking care of....</p>
		...
		<div class="contact-w3ls" id="contact">
			<div class="footer-w3lagile-inner">
				...
				<p class="para">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vitae eros eget tellus tristique bibendum. Donec rutrum sed sem quis venenatis.</p>
				...
				<div class="footer-grids w3-agileits">
					<div class="col-md-2 footer-grid">
						...
						<ul>
							<li>
								<a href="#" title="Release 2016">2016</a>
							</li>
							<li>
								<a href="#" title="Release 2015">2015</a>
							</li>
							<li>
								<a href="#" title="Release 2014">2014</a>
							</li>
							<li>
								<a href="#" title="Release 2013">2013</a>
							</li>
							<li>
								<a href="#" title="Release 2012">2012</a>
							</li>
							<li>
								<a href="#" title="Release 2011">2011</a>
							</li>
						</ul>
					</div>
					<div class="col-md-2 footer-grid">
						...
						<ul>
							...
							<li>
								<a href="series.html">FANTASY</a>
							</li>
							<li>
								<a href="series.html">ACTION </a>
							</li>
							<li>
								<a href="genre.html">MOVIES </a>
							</li>
							<li>
								<a href="horror.html">HORROR </a>
							</li>
					...
					<div class="col-md-2 footer-grid">
						...
						<ul class="w3-tag2">
							...
							<li>
								<a href="series.html">Historical</a>
							</li>
							<li>
								<a href="series.html">Romantic</a>
							</li>
							<li>
								<a href="series.html">Love</a>
							</li>
							<li>
								<a href="genre.html">Action</a>
							</li>
							<li>
								<a href="single.html">Reviews</a>
							</li>
							<li>
								<a href="comedy.html">Comedy</a>
							</li>
							...
							<li>
								<a href="genre.html">Historical</a>
							</li>
					...
					<ul class="bottom-links-agile">
						<li>
							<a href="icons.html" title="Font Icons">Icons</a>
						</li>
						<li>
							<a href="short-codes.html" title="Short Codes">Short Codes</a>
						</li>
						<li>
