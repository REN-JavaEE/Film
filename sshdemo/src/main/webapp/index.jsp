...
<script type="text/javascript">
	$(function() {
		...
		$("#login").click(function() {
			let name = $("#name").val();
			ws = new WebSocket("ws://localhost:8090/server/" + name);
...
<script type="text/javascript">
	$(function() {
		$.getJSON("http://localhost:8088/filminfo/getfilminfos",
				function(data) {
...
{{each list as filmInfo}}
<div class="w3l-movie-gride-agile">
<a href="http://localhost:8088/filminfo/getfilminfobyid?id={{filmInfo.id}}&qq=${qq}" class="hvr-sweep-to-bottom"><img
												src="{{filmInfo.photo}}" title="Movies Pro"
											...
											<div class="mid-1 agileits_w3layouts_mid_1_home">
												<div class="w3l-movie-text">
													<h6>
														<a href="http://localhost:8088/single.jsp">{{filmInfo.name}}</a>
													</h6>
												</div>
												<div class="mid-2 agile_mid_2_home">
													<p>{{filmInfo.onlineTime }}</p>
...
<body>
	...
	<div id="demo-1"
		...
		<div class="demo-inner-content">
				...
				<div class="inner-header-agile">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown">Genre <b class="caret"></b></a>
					...
					<div class="w3ls_search">
						...
						<div id="cd-search" class="cd-search">
							<form action="http://localhost:8088/filminfo/search" method="post">
								<input type="search" name="name" placeholder="Search...">
								<input type="hidden" name="qq" value="${qq }">
								<input type="submit" class="cd-search-trigger"  value="确定"  />
							</form>
						</div>
					</div>
			...
			<div class="baner-info">
				<h3>
					Latest <span>On</span>Line <span>Mo</span>vies
				</h3>
	...
	<div class="w3_agilits_banner_bootm">
		<div class="w3_agilits_inner_bottom">
			<div class="col-md-6 wthree_agile_login">
				<ul>
					<!-- <li><i class="fa fa-phone" aria-hidden="true"></i> (+086) 888
						888 8888</li> -->
						<li><a href="echart.html" class="login">好片分析</a></li>
					<c:if test="${empty qq}">
						<li><a href="#" class="login" data-toggle="modal"
							data-target="#myModal4">Login</a></li>
					</c:if>
					<c:if test="${not empty qq}">
						<span class="login" data-toggle="modal" data-target="#myModal4"><i>&amp;&amp;&amp;welcome！用户${qq }</i></span>
					</c:if>
					<li><a href="#" class="login reg" data-toggle="modal"
						data-target="#myModal5">Register</a>${message2}</li>
				...
				<div class="modal-header">
					...
					<div class="login-form">
						<form action="index" method="post">
							<input type="text" name="userA.qq" placeholder="QQ" required="">
							<input type="password" name="userA.password"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>Register</h4>
					<div class="login-form">
						<form id="register" action="http://localhost:8088/usera/register"
							method="post">
							<input type="text" name="userName" placeholder="UserName"
								required=""> <input type="text" name="realName"
								placeholder="真实姓名" required=""> <input type="text"
								name="gender" placeholder="性别" required=""> <input
								type="text" name="age" placeholder="年龄" required=""> <input
								type="text" id="vaild" name="qq" placeholder="QQ邮箱" required="">
							<input type="text" name="vaildCode" placeholder="请输入验证码" />
							<div
								style="background-color: darkgrey; width: 120px; height: 25px">
								<a id="getvaild" href="javascript:void(0)"> 请输入验证码</a>
							</div>
							<input type="password" name="password" placeholder="Password"
								required=""> <input type="password"
								name="conform password" placeholder="Confirm Password"
								required="">
		...
		<div class="agile_featured_movies">
						...
						<div class="tab1">
							<div class="tab_movies_agileinfo">
								<div class="w3_agile_featured_movies">
									<div class="col-md-5 video_agile_player">
										...
										<div class="player-text">
											...
											<p class="fexi_header_para">
												<span class="conjuring_w3">Story Line<label>:</label></span>Presenting
												the official trailer of Force 2 starring John Abraham,
												Sonakshi Sinha and Tahir Raj Bhasin A film by Abhinay Deo,
												Produced by Vipul Amrutlal Shah, JA entertainment Pvt.
												Ltd....
											</p>
											<p class="fexi_header_para">
												<span>Release On<label>:</label></span>Sep 29, 2016
											</p>
											<p class="fexi_header_para">
									...
									<div class="col-md-7 wthree_agile-movies_" id="filmInfo">
								...
								<div class="w3_agile_featured_movies">
									<div class="col-md-5 video_agile_player">
										...
										<div class="player-text">
											...
											<p class="fexi_header_para">
												<span class="conjuring_w3">Story Line<label>:</label></span>Me
												Before You Official Trailer #2 (2016) - Emilia Clarke, Sam
												Claflin Movie HD A girl in a small town forms an unlikely
												bond with a recently-paralyzed man she's taking care of....
											</p>
											<p class="fexi_header_para">
												<span>Release On<label>:</label></span>Feb 3, 2016
											</p>
											<p class="fexi_header_para">
												<span>Genres<label>:</label>
												</span> <a href="genre.html">Drama</a> | <a href="genre.html">Adventure</a>
									...
									<div class="col-md-7 wthree_agile-movies_list">
										<div class="w3l-movie-gride-agile">
											<a href="single.html" class="hvr-sweep-to-bottom"><img
												src="images/m9.jpg" title="Movies Pro"
												class="img-responsive" alt=" ">
												<div class="w3l-action-icon">
													<i class="fa fa-play-circle-o" aria-hidden="true"></i>
												</div> </a>
										...
										<div class="w3l-movie-gride-agile">
											<a href="single.html" class="hvr-sweep-to-bottom"><img
												src="images/m10.jpg" title="Movies Pro"
												class="img-responsive" alt=" ">
												<div class="w3l-action-icon">
													<i class="fa fa-play-circle-o" aria-hidden="true"></i>
												</div> </a>
											<div class="mid-1 agileits_w3layouts_mid_1_home">
												<div class="w3l-movie-text">
													<h6>
														<a href="single.html">Now You See Me 2</a>
													</h6>
												</div>
												<div class="mid-2 agile_mid_2_home">
													<p>2016</p>
										...
										<div class="w3l-movie-gride-agile">
											<a href="single.html" class="hvr-sweep-to-bottom"><img
												src="images/m11.jpg" title="Movies Pro"
												class="img-responsive" alt=" ">
												<div class="w3l-action-icon">
													<i class="fa fa-play-circle-o" aria-hidden="true"></i>
												</div> </a>
										...
										<div class="w3l-movie-gride-agile">
											<a href="single.html" class="hvr-sweep-to-bottom"><img
												src="images/m12.jpg" title="Movies Pro"
												class="img-responsive" alt=" ">
												<div class="w3l-action-icon">
													<i class="fa fa-play-circle-o" aria-hidden="true"></i>
												</div> </a>
											<div class="mid-1 agileits_w3layouts_mid_1_home">
												<div class="w3l-movie-text">
													<h6>
														<a href="single.html">Money Monster</a>
													</h6>
												</div>
												<div class="mid-2 agile_mid_2_home">
													<p>2016</p>
									...
									<div class="col-md-7 wthree_agile-movies_list">
										<div class="w3l-movie-gride-agile">
											...
											<div class="mid-1 agileits_w3layouts_mid_1_home">
												<div class="w3l-movie-text">
													<h6>
														<a href="single.jsp">Swiss Army Man </a>
													</h6>
												</div>
												<div class="mid-2 agile_mid_2_home">
													<p>2016</p>
										...
										<div class="w3l-movie-gride-agile">
											...
											<div class="mid-1 agileits_w3layouts_mid_1_home">
												<div class="w3l-movie-text">
													<h6>
														<a href="single.jsp">Me Before you</a>
													</h6>
												</div>
												<div class="mid-2 agile_mid_2_home">
													<p>2016</p>
				...
				<div id="owl-demo" class="owl-carousel owl-theme">
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.jsp" class="hvr-sweep-to-bottom"><img
								src="images/m5.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m6.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m7.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m8.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m3.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m11.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m14.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m13.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="single.html" class="hvr-sweep-to-bottom"><img
								src="images/m15.jpg" title="Movies Pro" class="img-responsive"
								alt=" " />
								<div class="w3l-action-icon">
									<i class="fa fa-play-circle-o" aria-hidden="true"></i>
								</div> </a>
			...
			<div class="wthree_agile-requested-movies">
				<div class="col-md-2 w3l-movie-gride-agile requested-movies">
					<a href="single.html" class="hvr-sweep-to-bottom"><img
						src="images/m1.jpg" title="Movies Pro" class="img-responsive"
						alt=" ">
						<div class="w3l-action-icon">
							<i class="fa fa-play-circle-o" aria-hidden="true"></i>
						</div> </a>
				...
				<div class="col-md-2 w3l-movie-gride-agile requested-movies">
					<a href="single.html" class="hvr-sweep-to-bottom"><img
						src="images/m2.jpg" title="Movies Pro" class="img-responsive"
						alt=" ">
						<div class="w3l-action-icon">
							<i class="fa fa-play-circle-o" aria-hidden="true"></i>
						</div> </a>
				...
				<div class="col-md-2 w3l-movie-gride-agile requested-movies">
					<a href="single.html" class="hvr-sweep-to-bottom"><img
						src="images/m4.jpg" title="Movies Pro" class="img-responsive"
						alt=" ">
						<div class="w3l-action-icon">
							<i class="fa fa-play-circle-o" aria-hidden="true"></i>
						</div> </a>
				...
				<div class="col-md-2 w3l-movie-gride-agile requested-movies">
					<a href="single.html" class="hvr-sweep-to-bottom"><img
						src="images/m9.jpg" title="Movies Pro" class="img-responsive"
						alt=" ">
						<div class="w3l-action-icon">
							<i class="fa fa-play-circle-o" aria-hidden="true"></i>
						</div> </a>
	...
	<div class="contact-w3ls" id="contact">
		<div class="footer-w3lagile-inner">
			...
			<div class="footer-grids w3-agileits">
				...
				<div class="col-md-2 footer-grid">
					<h4 class="b-log">
						<a href="index.html"><span>M</span>ovies <span>P</span>ro</a>
					</h4>
					<div class="footer-grid-instagram">
						<a href="single.jsp"><img src="images/m1.jpg" alt=" "
							class="img-responsive"></a>
					</div>
					<div class="footer-grid-instagram">
						<a href="single.jsp"><img src="images/m2.jpg" alt=" "
							class="img-responsive"></a>
					</div>
					<div class="footer-grid-instagram">
				...
				<ul class="bottom-links-agile">
					...
					<li><a href="short-codes.html" title="Short Codes">Short
							Codes</a></li>
	...
	<script type="text/javascript">
		$("#getvaild").click(function() {
			$.ajax({
				url : "usera/getvaildcode?qq=" + $("#vaild").val()
			})
		})
		$(document).ready(function() {
